...
import { Legend, NavigationBar, LabelBullet } from "@amcharts/amcharts4/charts"
...
export class TreeMapChartManager extends BaseTreeMapChartManager {
  constructor(container: HTMLElement) {
    ...
    const level2Bullet = level2.bullets.push(new LabelBullet())
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  private addServicesOrComponents(dataManager: DataManager, items: Array<any>,
