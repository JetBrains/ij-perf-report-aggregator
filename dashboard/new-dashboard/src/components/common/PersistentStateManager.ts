...
import { valueUnitParamName } from "./chart"
...
export class PersistentStateManager {
  ...
  private updateUrlQuery() {
    ...
    const filteredQuery = Object.fromEntries(Object.entries(query).filter(([key]) => [...this.knownKeys, pointParamName, analysisParamName, valueUnitParamName].includes(key)))
