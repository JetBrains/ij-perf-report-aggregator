...
const gcCharts: ChartDef[] = [
  ...
  {
    key: "freedByFullGC",
    label: "Freed by full GC (MiB)",
    measure: "freedMemoryByFullGC",
    valueUnit: "counter",
    description: "Memory reclaimed by full GC only. High values signal promotion pressure.",
  },
  {
    key: "fullGCPause",
    label: "Full GC pause (ms)",
    measure: "fullGCPause",
    valueUnit: "ms",
    description: "Time the IDE was fully paused during full GC. Any spike is a responsiveness killer.",
  },
  {
    key: "g1MarkCycles",
    label: "G1 concurrent mark cycles",
    measure: "g1gcConcurrentMarkCycles",
    valueUnit: "counter",
    description: "Number of G1 concurrent marking cycles. Rising count = heap pressure.",
  },
  {
    key: "g1MarkTime",
    label: "G1 concurrent mark time (ms)",
    measure: "g1gcConcurrentMarkTimeMs",
    valueUnit: "ms",
    description: "Wall time spent in G1 concurrent marking. Competes with UI threads.",
  },
  {
    key: "g1ShrinkCount",
    label: "G1 heap shrinkage count",
    measure: "g1gcHeapShrinkageCount",
    valueUnit: "counter",
    description: "How often G1 returned heap to OS. Zero means heap is pinned at max.",
  },
  {
    key: "g1ShrinkMb",
    label: "G1 heap shrinkage (MiB)",
    measure: "g1gcHeapShrinkageMegabytes",
    valueUnit: "counter",
    description: "Total heap memory returned to OS by G1 shrinkage.",
  },
]
...
const memoryCharts: ChartDef[] = [
  ...
  {
    key: "ramMinusMappings",
    label: "RAM minus mappings",
    measure: "MEM.avgRamMinusFileMappingsMegabytes",
    description: "Resident RAM excluding file mappings — the true heap + off-heap footprint.",
  },
...
const jvmCharts: ChartDef[] = [
  {
    key: "maxThreads",
    label: "Max threads",
    measure: "JVM.maxThreadCount",
    valueUnit: "counter",
    description: "Peak thread count. Unexpected growth signals thread leaks or misconfiguration.",
  },
  {
    key: "totalCpu",
    label: "Total CPU (ms)",
    measure: "JVM.totalCpuTimeMs",
    valueUnit: "ms",
    description: "Cumulative CPU time across all threads. Versus wall-clock time, reveals CPU saturation.",
  },
  {
    key: "safepointTime",
    label: "Safepoint time (ms)",
    measure: "JVM.totalTimeToSafepointsMs",
    valueUnit: "ms",
    description: "Time threads spent blocked at JVM safepoints. Above 50 ms indicates contention.",
  },
  {
    key: "gcCollectionTime",
    label: "GC collection time (ms)",
    measure: "JVM.GC.collectionTimesMs",
    valueUnit: "ms",
    description: "JVM-reported total GC time. Independent cross-check against gcPause.",
  },
]
</script>
