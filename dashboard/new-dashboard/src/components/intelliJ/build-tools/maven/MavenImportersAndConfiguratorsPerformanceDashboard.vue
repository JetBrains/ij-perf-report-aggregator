...
const workspaceConfiguratorsMetricTypes = [...importerRunMetricTypes, "after_apply_duration_ms", "before_apply_duration_ms", "collect_folders_duration_ms", "config_modules_duration_ms"]
