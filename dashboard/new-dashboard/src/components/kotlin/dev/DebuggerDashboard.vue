<template>
  <DashboardPage
    ...
    db-name="perfintDev"
    table="kotlin"
    persistent-id="kotlinDev_debugger_dashboard"
    ...
    <section class="flex gap-6">
      <div class="flex-1 min-w-0">
        <AggregationChart
          ...
          :aggregated-measure="'evaluateExpression\_%'"
          :aggregated-project="'%\_k1'"
          :is-like="true"
          :title="'mean all project evaluate-expression K1'"
        />
      </div>
      <div class="flex-1 min-w-0">
        <AggregationChart
          ...
          :is-like="true"
          :title="'mean all project evaluate-expression K2'"
        />
      </div>
    </section>
...
const { evaluateExpressionCharts } = createKotlinCharts(projectConfigurator)
</script>
