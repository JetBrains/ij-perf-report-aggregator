<template>
  ...
  >
    ...
    <section class="flex gap-x-6">
      <div class="flex-1 min-w-0">
        <GroupProjectsChart
          label="Intellij localInspections mean value with Library cache K1"
          measure="localInspections#mean_value"
          :projects="[
      ...
      <div class="flex-1 min-w-0">
        <GroupProjectsChart
          label="Intellij localInspections mean value with Library cache K2"
          measure="localInspections#mean_value"
          :projects="[
    ...
    <section class="flex gap-x-6">
      ...
      <div class="flex-1 min-w-0">
        <GroupProjectsChart
          label="'TBE' localInspections mean value with Library cache K2"
          measure="localInspections#mean_value"
          :projects="[
    ...
    <section class="flex gap-x-6">
      <div class="flex-1 min-w-0">
        <GroupProjectsChart
          label="'Android canary leak' localInspections mean value with Library cache K1"
          measure="localInspections#mean_value"
          :projects="[
      ...
      <div class="flex-1 min-w-0">
        <GroupProjectsChart
          label="'Android canary leak' localInspections mean value with Library cache K2"
          measure="localInspections#mean_value"
          :projects="[
