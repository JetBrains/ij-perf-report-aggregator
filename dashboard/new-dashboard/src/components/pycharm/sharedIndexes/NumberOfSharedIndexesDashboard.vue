<template>
  <DashboardPage
    db-name="perfint"
    table="pycharm"
    persistent-id="py_number_of_shared_indexes_dashboard"
    ...
    <section>
      <div>
        <GroupProjectsChart
          ...
          :key="'Number of files Indexed by shared indexes (' + test_project.pretty_name + ')'"
          :label="'Number of files Indexed by shared indexes (' + test_project.pretty_name + ')'"
