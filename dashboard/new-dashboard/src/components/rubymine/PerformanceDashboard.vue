    ...
    <section>
      <GroupProjectsChart
        ...
        :aliases="[
          ...
          'Module (GL2)',
          'Method (GL2)',
          'Singleton Method (GL2)',
          'Instance Variable (GL2)',
          'Class Variable (GL2)',
          'Global Variable (GL2)',
          'Delegate Method (GL2)',
          'Association (GL2)',
    ...
    <section>
      <GroupProjectsChart
        ...
        :aliases="[
          ...
          'Class Find Usage (GL2)',
          'Module Find Usage (GL2)',
          'Method Find Usage (GL2)',
          'Singleton Method Find Usage (GL2)',
          'Instance Variable Find Usage (GL2)',
          'Class Variable Find Usage (GL2)',
          'Global Variable Find Usage (GL2)',
          'Delegate Method Find Usage (GL2)',
          'Association Find Usage (GL2)',
          'I18n Key (MA)',
