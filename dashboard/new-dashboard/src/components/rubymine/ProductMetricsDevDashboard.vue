...
const chartsDeclaration: ChartDefinition[] = [
  ...
  {
    labels: ["Completion Cold Cache (Diaspora)"],
  ...
  {
    labels: ["Completion Hot Cache (Diaspora)"],
    measures: ["completion#mean_value"],
    projects: [
  ...
  {
    labels: ["Completion Cold Cache (GitLab)"],
    measures: ["completion#mean_value"],
    projects: [
  ...
  {
    labels: ["Completion Hot Cache (GitLab)"],
    measures: ["completion#mean_value"],
    projects: [
  ...
  {
    labels: ["Completion Cold Cache (Redmine)"],
    measures: ["completion#mean_value"],
    projects: [
  ...
  {
    labels: ["Completion Hot Cache (Redmine)"],
    measures: ["completion#mean_value"],
    projects: [
