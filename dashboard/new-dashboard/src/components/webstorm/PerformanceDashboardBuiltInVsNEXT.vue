...
const groups = [
  {
    ...
    projects: [
      ...
      "vue3-realworld-example-app/completion/Article/attribute/",
      "vue3-realworld-example-app/completion/Article/component/",
      "npmx-dev/completion/AppFooter/component/",
      "npmx-dev/completion/AppFooter/attribute/",
      "vue-vben-admin/completion/vben-alert-demo/completion/",
      "vue-vben-admin/completion/tool-more/completion/",
  ...
  },
  {
    ...
    projects: [
      ...
      "vue3-realworld-example-app/localInspection/EditArticle/local-inspection/",
      "npmx-dev/localInspection/AppFooter/local-inspection/",
      "vue-vben-admin/localInspection/vben-use-form/local-inspection/",
  ...
  },
  {
    ...
    projects: [
      ...
      "vue3-realworld-example-app/typing/Profile/typing/",
    ],
  },
  {
  ...
  },
  {
    ...
    projects: [
      ...
      "ring-ui/indexing",
      "vkui/indexing",
      "vue3-realworld-example-app/indexing",
      "npmx-dev/indexing",
    ],
  },
]
