...
const groups = [
  {
    ...
    projects: [
      ...
      "vue-vben-admin/completion/vben-alert-demo",
      "vue-vben-admin/completion/tool-more",
  ...
  },
  {
    ...
    projects: [
      ...
      "vue3-realworld-example-app/localInspection/EditArticle",
      "npmx-dev/localInspection/AppFooter",
      "vue-vben-admin/localInspection/vben-use-form",
