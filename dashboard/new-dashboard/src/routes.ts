...
enum ROUTES {
  ...
  PhpStormMemoryDashboard = `${ROUTE_PREFIX.PhpStorm}/memoryDashboard`,
  ...
  ClionRunGutterDashboard = `${ROUTE_PREFIX.Clion}/runGutterDashboard`,
  ...
  ClionGotoDeclarationDashboard = `${ROUTE_PREFIX.Clion}/gotoDeclarationDashboard`,
  ClionFindUsageDashboard = `${ROUTE_PREFIX.Clion}/findUsageDashboard`,
  ClionCMakeLanguageDashboard = `${ROUTE_PREFIX.Clion}/cmakeLanguageDashboard`,
  ...
  children: [
    {
      ...
      tabs: [
        ...
        tab(ROUTES.PhpStormMemoryDashboard, "Memory"),
  ...
  children: [
    {
      ...
      tabs: [
        ...
        tab(ROUTES.ClionGotoDeclarationDashboard, "Go to Declaration"),
        tab(ROUTES.ClionRunGutterDashboard, "Run Gutter"),
        ...
        tab(ROUTES.ClionCMakeLanguageDashboard, "CMake Language"),
...
const phpstormRoutes = [
  ...
  dashboard(ROUTES.PhpStormMemoryDashboard, () => import("./components/phpstorm/MemoryDashboard.vue"), "PhpStorm Memory Dashboard"),
...
const clionRoutes = [
  ...
  dashboard(ROUTES.ClionRunGutterDashboard, () => import("./components/clion/CLionRunGutterDashboard.vue"), "CLion Run Gutter dashboard"),
  dashboard(ROUTES.ClionIndexingDashboard, () => import("./components/clion/CLionIndexingDashboard.vue"), "CLion Indexing dashboard"),
  ...
  dashboard(ROUTES.ClionGotoDeclarationDashboard, () => import("./components/clion/CLionGotoDeclarationDashboard.vue"), "CLion Go to Declaration dashboard"),
  dashboard(ROUTES.ClionFindUsageDashboard, () => import("./components/clion/FindUsageDashboard.vue"), "CLion Find Usages dashboard"),
