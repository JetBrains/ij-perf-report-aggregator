...
export class TimelineChartManager extends BaseTimeLineChartManager {
  ...
  constructor(container: HTMLElement) {
    ...
    this.statsLabel = this.chart.createChild(Label)
  ...
  render(data: DataManager): void {
    ...
    const durationAxis = this.chart.xAxes.getIndex(0) as DurationAxis
  ...
  private transformIjData(data: InputData): Array<unknown> {
  ...
  private computeRowIndexForMainActivities(items: Array<TimeLineItem>, colorSet: ColorSet) {
