...
import { getOrCreateReportVisualizerSettings, reportVisualizerModuleName } from "@/state/state"
...
@Component
  export default class InputForm extends Vue {
    ...
    beforeMount() {
      getOrCreateReportVisualizerSettings(this.$store)
    }
    ...
    set inputData(value: string | null) {
      // ensure that module is registered
      getOrCreateReportVisualizerSettings(this.$store)
      this.$store.commit(`${reportVisualizerModuleName}/updateData`, value)
    }

    get portNumber() {
      return getOrCreateReportVisualizerSettings(this.$store).recentlyUsedIdePort
    }
    set portNumber(value: number) {
      this.$store.commit(`${reportVisualizerModuleName}/updateRecentlyUsedIdePort`, value)
    }
