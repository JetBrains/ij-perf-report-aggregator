...
const routes: Array<RouteConfig> = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/aggregatedStats/IntelliJDashboard.vue"),
      },
      {
        path: "/fleetStats",
        name: "Fleet Dashboard",
        component: () => import("extraDashboards/FleetDashboard.vue"),
      },
      {
        path: "/sharedIndexes",
        name: "SharedIndexes Dashboard",
        component: () => import("@/aggregatedStats/SharedIndexesDashboard.vue"),
      },
      {
