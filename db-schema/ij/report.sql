...
(
  ...
  `machine`                    Enum8('intellij-macos-hw-unit-1550' = 1, 'intellij-macos-hw-unit-1551' = 2, 'intellij-windows-hw-unit-499' = 3, 'intellij-windows-hw-unit-498' = 4,
    ...
    'intellij-windows-hw-unit-449' = 17, 'intellij-windows-hw-unit-463' = 18, 'intellij-windows-hw-unit-504' = 19, 'intellij-windows-hw-unit-493' = 20, 'intellij-linux-hw-unit-499' = 21, 'intellij-macos-hw-unit-2204' = 22, 'intellij-macos-hw-unit-2205' = 23) CODEC(ZSTD(20)),
