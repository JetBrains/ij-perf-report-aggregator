...
func createDbSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "create-db.sql", size: 329, mode: os.FileMode(420), modTime: time.Unix(1569572906, 0)}
